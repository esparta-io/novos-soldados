package com.example.luan.esparta.util;
...
import com.example.luan.esparta.R;
...
public class Util {
    ...
    public static void showMsgToast(Activity activity, String txt) {
        ...
        View lytToast = inflater.inflate(R.layout.toast_templete, (ViewGroup) activity.findViewById(R.id.lytToast));
